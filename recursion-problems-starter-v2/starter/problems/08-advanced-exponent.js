...
advancedExponent(2, 2); // 4      (2 x 2 ) x ( 2 x 2 ) === 4 x 4
advancedExponent(2, 3); // 8
advancedExponent(2, 4); // 16     2 x 2 x 2 x 2
...
//   else if (n > 1) {
//     return Math.pow((b * advancedExponent(b, n -2)), 2);
//   }
// }
...
function advancedExponent(b, n) {
  ...
  //   return b;}
  // if (n === 2){
  //   return (advancedExponent(b, n -1)) * (advancedExponent(b, n -1));
  // }
  // if (n > 2) {
